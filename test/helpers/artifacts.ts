...
export const GovernanceLockableTest = artifacts.require(
...
export const ERC20PredicateBurnOnly = artifacts.require(
  "ERC20PredicateBurnOnly"
);
export const ERC721Predicate = artifacts.require("ERC721Predicate");
export const ERC721PredicateBurnOnly = artifacts.require(
  "ERC721PredicateBurnOnly"
);
export const MintableERC721Predicate = artifacts.require(
